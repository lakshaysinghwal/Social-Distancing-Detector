...
ap.add_argument("-i", "--input", type=str, default="./resources/videos/test.mp4",
	help="path to (optional) input video file")
ap.add_argument("-o", "--output", type=str, default="resources/videos/output/test3.avi",
...
# load the COCO class labels our YOLO model was ned on
